	...
	if($data_call_module_config):
		foreach($data_call_module_config as $id => $module):
			...
			<tr>
				...
				<td class="tdcenter"><div style="position:relative;"><input type="hidden" value="kl_data_call_for_internal(<?php echo $module['did']; ?>, $cols=1, $col=1)" /><input type="button" id="internal_call_function_<?php echo $module['did']; ?>" value="复制" class="copy" /></div></td>
				<td class="tdcenter"><div style="position:relative;"><input type="hidden" value="<?php echo BLOG_URL; ?>content/plugins/kl_data_call/kl_data_call_do.php?callback=html&ID=<?php echo $module['did']; ?>&COLS=1&COL=1" /><input type="button" id="external_html_call_function_<?php echo $module['did']; ?>" value="复制" class="copy" /></div></td>
				<td class="tdcenter"><div style="position:relative;"><input type="hidden" value="<?php echo htmlspecialchars('<script charset="utf-8" type="text/javascript" src="'.BLOG_URL.'content/plugins/kl_data_call/kl_data_call_do.php?ID='.$module['did'].'&COLS=1&COL=1"></script>');?>" /><input type="button" id="external_js_call_function_<?php echo $module['did']; ?>" value="复制" class="copy" /></div></td>
		...
		<tr><td class="tdcenter" colspan="8">还没有添加数据调用</td></tr>
	<?php endif;?>
	</tbody>
</table>
<script type="text/javascript">
