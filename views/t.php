...
<form action="./plugin.php?plugin=kl_data_call&action=setting&act=<?php echo $act; ?>" method="POST">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table_b">
		...
		<tr><td align="left">个人定制：</td><td><input id="custom_tailor" name="custom_tailor" type="text" value="<?php echo isset($module['custom_tailor']) ? $module['custom_tailor'] : ''; ?>" /><font color="green"> * 此选项可以填入要调用的<strong>微语id</strong>,用<strong>半角的逗号(,)</strong>分隔即可，如(20,15,16,25)。</font><font color="red">(优先级：高)</font></td></tr>
